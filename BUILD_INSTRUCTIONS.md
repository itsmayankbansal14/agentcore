...
- Windows 10 or 11
- Python **3.12.x ONLY** installed (NOT 3.11, NOT 3.13+)
...
- Install Python 3.12 from https://www.python.org/downloads/ and make sure **"Add Python to PATH"** is checked.
...
- Make sure you are using Python 3.12 ONLY (not 3.11, not 3.13+).
- Run `python --version` to verify you have exactly 3.12.x.
